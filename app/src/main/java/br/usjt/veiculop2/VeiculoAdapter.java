...
public class VeiculoAdapter extends BaseAdapter implements SectionIndexer
{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view == null) {
            ...
            TextView nomeVeiculo = (TextView)view.findViewById(R.id.nomeVeiculoTextView);
            ...
            view.setTag(new ViewHolder(fotinhoVeiculo, nomeVeiculo, detalhesVeiculo));
        }
        //usa os widgets cacheados na view reciclada
        ViewHolder holder = (ViewHolder)view.getTag();
        //carrega os novos valores
        Drawable drawable = Util.getDrawable(context, veiculos[position].getImagem());
        ...
        holder.getDetalhesVeiculo().setText(String.format("%s - %s", veiculos[position].getAno(),
